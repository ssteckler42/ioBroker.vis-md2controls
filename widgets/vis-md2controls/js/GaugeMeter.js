        ...
        return this.each(function () {
            ...
            function getThemeColor(e) {
                ...
                return e || (e = 1e-14),
                    ...
                    "Temperature" === option.theme && option.theme && (e > 0 && (t = "#266dfc"), e > 10 && (t = "#26b5fc"), e > 20 && (t = "#26fce5"), e > 30 && (t = "#26fc9e"), e > 40 && (t = "#26fc46"), e > 50 && (t = "#26fc46"), e > 60 && (t = "#97fc26"), e > 70 && (t = "#e9fc26"), e > 80 && (t = "#f01000"), e > 90 && (t = "#ff0000")),
                    "Humidity" === option.theme && option.theme && (e > 0 && (t = "#fc3326"), e > 10 && (t = "#fc5d26"), e > 20 && (t = "#fca826"), e > 30 && (t = "#ecfc26"), e > 40 && (t = "#53fc26"), e > 50 && (t =  "#53fc26"), e > 60 && (t =  "#53fc26"), e > 70 && (t = "#fca826"), e > 80 && (t = "#fcdc26"), e > 90 && (t = "#fc7726")),
                    t;
            }
            ...
            function getDataAttr(t) {
                $.each(dataAttr, function (index, element) {
                    if(t.data(element) !== undefined && t.data(element) !== null && t.data(element) !== "" ) {
            ...
            if(isNumber(option.used) && isNumber(option.total)){
                var u = option.used + option.used_adjust;
                var t = option.total;
                if(isNumber(option.min)) {
                    if(option.min > 0) {
                        t -= option.min;
                        u -= option.min;
                    }
                ...
                if(isNumber(option.percent)){
                    c = option.percent;
                } else {
                    c = parseFloat(defaults.percent);
                }
            }
            if(c < 0) c = 0;
            if(c > 100) c = 100;
            ...
            if( option.text !== "" && option.text !== null && option.text !== undefined){
                ...
                if(defaults.showvalue === true || option.showvalue === true){
					if (isNumber(option.used)) {
                        r = (option.used + option.used_adjust).toFixed(option.digits);
					} else {
						r= "";
					}
                } else {
                    r = c.toFixed(option.digits);
                }
